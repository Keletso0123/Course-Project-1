...
This assignment aims at providing R code required for plotting 4 per-defined plots
...
hist(as.numeric(as.character(subpower$Global_active_power)), col = "red", main = "Global Acrive Power", xlab = "Global Active Power (kilowats)")
